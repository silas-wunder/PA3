...
public class RWPageRank {
        public static void main(String[] args) throws Exception {
                ...
                JavaPairRDD<Long, Double> ranksSorted = ranks.mapToPair(x -> new Tuple2<>(x._2(), x._1())).sortByKey()
                                .mapToPair(x -> new Tuple2<>(x._2(), x._1()));
                JavaPairRDD<String, Double> ranksTitled = ranksSorted.join(titles).values()
                                .mapToPair(x -> new Tuple2<String, Double>(x._2(), x._1()));
                ranksTitled.saveAsTextFile(args[2]);
        }
}
