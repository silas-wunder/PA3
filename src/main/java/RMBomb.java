...
public class RMBomb {
    public static void main(String[] args) throws Exception {
        ...
        //above is normal code for pageRank

        JavaRDD<String> keysurf = "surfing";
        JavaPairRDD<Long, String> surfTitles = titles.filter(); //doesn't work

        //below is normal code for pageRank
